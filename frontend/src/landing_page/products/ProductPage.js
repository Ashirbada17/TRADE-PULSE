...
function ProductPage() {
    return ( 
        <div>
            ...
            <RightSection imageURL="media\images\console.png" productName="Console" productDescription="The central dashboard for your TradePulse account. Gain insights into your trades and investments with in-depth reports and visualisations." tryDemo="#" learnMore="#" googlePlay appStore/>
            ...
            <h4 className='text-center mt-5 text-muted'>Want to know more about our technology stack? Check out the <a href='#'>TradePulse.tech </a>blog.</h4>
            <Universe/>
        </div>
    );
}
